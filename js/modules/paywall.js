...
function showPrePaywall() {
  ...
  setHtml(`
    ...
    <div class="info-box" style="margin-bottom: 20px;">⚠️ O desbloqueio é irreversível. Confirme antes de confirmar.</div>

    <div class="result-card large" style="padding: 20px; margin-bottom: 10px;">
    ...
    <div class="result-card large" style="padding: 20px; margin-bottom: 30px;">
      <div class="card-large-left">
        <div class="qrc-label">🔒 Valor total do imóvel</div>
        <div class="qrc-note"></div>
      </div>
...
function showPaywall() {
  ...
  overlay.innerHTML = `
    <div class="paywall-card">
      ...
      <div class="paywall-title">Suas novas funcionalidades</div>
      <div class="paywall-sub">Previsão e acompanhamento de parcelas mês a mês com maior precisão · Histórico de parcelas detalhado com % de evolução de obra · Previsão das prestações futuras · Mais funções em desenvolvimento (Em breve!) </div>
      <div class="info-box" style="margin: 14px 0 0; text-align: left;"><strong>Lembre-se: O desbloqueio é feito individualmente, para cada perfil.</strong></div>
